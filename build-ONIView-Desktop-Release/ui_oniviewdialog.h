...
public:
    ...
    QPushButton *pushButton_setFocusOnSlider;
    QCheckBox *checkBox_isDelete;
    ...
    void setupUi(QDialog *ONIViewDialog)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 522, 1281, 166));
        ...
        pushButton_setFocusOnSlider = new QPushButton(layoutWidget);
        pushButton_setFocusOnSlider->setObjectName(QString::fromUtf8("pushButton_setFocusOnSlider"));

        verticalLayout->addWidget(pushButton_setFocusOnSlider);

        checkBox_isDelete = new QCheckBox(layoutWidget);
        checkBox_isDelete->setObjectName(QString::fromUtf8("checkBox_isDelete"));

        verticalLayout->addWidget(checkBox_isDelete);
...
"}"));
    ...
    void retranslateUi(QDialog *ONIViewDialog)
    {
        ...
        pushButton_setFocusOnSlider->setText(QApplication::translate("ONIViewDialog", "SetSlider&Focus", 0, QApplication::UnicodeUTF8));
        checkBox_isDelete->setText(QApplication::translate("ONIViewDialog", "&DeleteID", 0, QApplication::UnicodeUTF8));
