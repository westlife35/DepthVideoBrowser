...
#include "EventLevel/eventInfo.h"
...
public:
  ...
  bool bIsCheckBoxLooseStartTimeChecked;
  bool bISCheckBoxTightenedStartTimeChecked;
  bool bIsCheckBoxTightenedEndTimeChecked;
  bool bIsCheckBoxLooseEndTimeChecked;
...
//  void on_checkBox_isDelete_clicked();
  void on_checkBox_looseStartTime_clicked();
  void on_checkBox_tightenedStartTime_clicked();
  void on_checkBox_tightenedEndTime_clicked();
  void on_checkBox_looseEndTime_clicked();
